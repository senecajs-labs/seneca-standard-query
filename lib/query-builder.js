...
function buildQueryFromExpressionCustom (entp, query_parameters, sTypes, values, parseExpressionFc) {
  function parseOr (entp, sTypes, current_name, current_value, params, values) {
    ...
    for (var i in current_value) {
      ...
      var current_result = buildQueryFromExpressionCustom(entp, w, sTypes, values, parseExpressionFc)
