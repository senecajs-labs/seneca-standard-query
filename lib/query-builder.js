...
function parseExpression (entp, sTypes, current_name, current_value, params, values) {
  ...
  if (operator.current_name) {
    parseOperation(entp, sTypes, current_name, current_value, params, values, operator.current_name)
    return result
  }
...
function parseOperation (entp, sTypes, current_name, current_value, params, values, operator) {
